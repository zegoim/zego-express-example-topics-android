...
import com.zego.expresssample.databinding.ActivitySettingBinding;
...
public class SettingActivity extends AppCompatActivity {
    ...
    private void saveSetting() {
        ...
        // env
        PreferenceUtil.getInstance().setBooleanValue(KEY_TEST_ENVIRONMENT, binding.spEnv.getSelectedItemPosition() == 0);
    }

    // 获取 SDK 版本
    public String getSdkVersion() {
        return sdkVersion+ ZegoExpressEngine.getVersion();
    }
    ...
    public String getLocalVersionName(Context ctx) {
        ...
        try {
            ...
            Log.e("zegoexpresssample","not found package name" + e.getMessage());
