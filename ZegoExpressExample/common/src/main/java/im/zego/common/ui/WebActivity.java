...
import im.zego.common.databinding.ActivityWebviewBinding;

/**
 * WebActivity
 * <p>
 * 一个简单的浏览器，调用 {@link #actionStart(Activity, String, String)} 即可跳转到指定url页面
 * A simple browser, call {@link #actionStart (Activity, String, String)} to jump to the specified url page
 */
public class WebActivity extends BaseActivity {
    ...
    public void goMenu(View view) {
        ...
        //    指定下拉列表的显示数据
        //    Specify the display data of the drop-down list
        ...
        builder.setItems(cities, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (cities[which].equals(getString(R.string.tx_menu_copy_link))) {
                    ClipboardManager clip = (ClipboardManager) WebActivity.this.getSystemService(CLIPBOARD_SERVICE);
